...
set(ANDROID_OUTPUT_DIR ${CMAKE_CURRENT_BINARY_DIR}/android-build)
...
#    endif()
    ...
    configure_file(${QT_ANDROID_SOURCE_DIR}/android_deployment_settings.json.in ${CMAKE_CURRENT_BINARY_DIR}/android_deployment_settings.json @ONLY)
    ...
    set(tttt ${ANDROID_OUTPUT_DIR}/libs/${ANDROID_ABI})
    message(STATUS "tttt: ${tttt}")
    ...
    add_custom_target(
        ...
        COMMAND ${CMAKE_COMMAND} -E make_directory ${tttt}
        COMMAND ${CMAKE_COMMAND} -E copy ${QT_ANDROID_APP_PATH} ${ANDROID_OUTPUT_DIR}/libs/${ANDROID_ABI}
        COMMAND ${QT_ANDROID_QT_ROOT}/bin/androiddeployqt --verbose --output ${ANDROID_OUTPUT_DIR} --input ${CMAKE_CURRENT_BINARY_DIR}/qtdeploy.json --gradle ${TARGET_LEVEL_OPTIONS} ${INSTALL_OPTIONS} ${SIGN_OPTIONS}
    )
